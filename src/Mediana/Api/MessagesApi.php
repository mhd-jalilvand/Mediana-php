...
/**
    ...
    public function createPatternWithHttpInfo($pattern_to_create, string $contentType = self::contentTypes['createPattern'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mediana\Sdk\Model\InlineResponse2003' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Mediana\Sdk\Model\InlineResponse2003' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Mediana\Sdk\Model\InlineResponse2003', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\Mediana\Sdk\Model\InlineResponse401' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Mediana\Sdk\Model\InlineResponse401' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Mediana\Sdk\Model\InlineResponse401', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mediana\Sdk\Model\InlineResponse2003',
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mediana\Sdk\Model\InlineResponse401',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Mediana\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mediana\Sdk\Model\InlineResponse2006|\Mediana\Sdk\Model\InlineResponse401
     */
     ...
     * @throws \Mediana\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mediana\Sdk\Model\InlineResponse2006|\Mediana\Sdk\Model\InlineResponse401, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchInboxMessagesWithHttpInfo($page = null, $limit = null, string $contentType = self::contentTypes['fetchInboxMessages'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mediana\Sdk\Model\InlineResponse2006' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Mediana\Sdk\Model\InlineResponse2006' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Mediana\Sdk\Model\InlineResponse2006', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Mediana\Sdk\Model\InlineResponse2006';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mediana\Sdk\Model\InlineResponse2006',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Mediana\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mediana\Sdk\Model\InlineResponse2005|\Mediana\Sdk\Model\InlineResponse401
     */
     ...
     * @throws \Mediana\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mediana\Sdk\Model\InlineResponse2005|\Mediana\Sdk\Model\InlineResponse401, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessageRecipientsStatusWithHttpInfo($bulk_id, $page = null, $limit = null, string $contentType = self::contentTypes['getMessageRecipientsStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mediana\Sdk\Model\InlineResponse2005' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Mediana\Sdk\Model\InlineResponse2005' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Mediana\Sdk\Model\InlineResponse2005', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Mediana\Sdk\Model\InlineResponse2005';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mediana\Sdk\Model\InlineResponse2005',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Mediana\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mediana\Sdk\Model\InlineResponse2004|\Mediana\Sdk\Model\InlineResponse401
     */
     ...
     * @throws \Mediana\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mediana\Sdk\Model\InlineResponse2004|\Mediana\Sdk\Model\InlineResponse401, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSMSWithHttpInfo($bulk_id, string $contentType = self::contentTypes['getSMS'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mediana\Sdk\Model\InlineResponse2004' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Mediana\Sdk\Model\InlineResponse2004' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Mediana\Sdk\Model\InlineResponse2004', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Mediana\Sdk\Model\InlineResponse2004';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mediana\Sdk\Model\InlineResponse2004',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function sendPatternWithHttpInfo($pattern_to_send, string $contentType = self::contentTypes['sendPattern'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mediana\Sdk\Model\InlineResponse2002' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Mediana\Sdk\Model\InlineResponse2002' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Mediana\Sdk\Model\InlineResponse2002', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mediana\Sdk\Model\InlineResponse2002',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
