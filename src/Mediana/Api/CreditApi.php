...
/**
     ...
     * @return \Mediana\Sdk\Model\InlineResponse2001|\Mediana\Sdk\Model\InlineResponse401
     */
     ...
     * @throws \Mediana\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mediana\Sdk\Model\InlineResponse2001|\Mediana\Sdk\Model\InlineResponse401, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCreditWithHttpInfo(string $contentType = self::contentTypes['getCredit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mediana\Sdk\Model\InlineResponse2001' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Mediana\Sdk\Model\InlineResponse2001' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Mediana\Sdk\Model\InlineResponse2001', []),
            ...
            $returnType = '\Mediana\Sdk\Model\InlineResponse2001';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mediana\Sdk\Model\InlineResponse2001',
