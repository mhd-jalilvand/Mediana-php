...
/**
     ...
     * @return \Mediana\Sdk\Model\GetCredit200Response|\Mediana\Sdk\Model\GetAuthorizedUser401Response
     */
     ...
     * @throws \Mediana\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Mediana\Sdk\Model\GetCredit200Response|\Mediana\Sdk\Model\GetAuthorizedUser401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCreditWithHttpInfo(string $contentType = self::contentTypes['getCredit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Mediana\Sdk\Model\GetCredit200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Mediana\Sdk\Model\GetCredit200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Mediana\Sdk\Model\GetCredit200Response', []),
            ...
            $returnType = '\Mediana\Sdk\Model\GetCredit200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Mediana\Sdk\Model\GetCredit200Response',
