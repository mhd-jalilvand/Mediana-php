...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://rest.ippanel.com';

    /**
     * User agent of the HTTP request, set to "Mediana-SDK-Agent/{version}/PHP" by default
     *
     * @var string
     */
    protected $userAgent = 'Mediana-SDK-Agent/1.0.0/PHP';
    ...
    {
        $report  = 'PHP SDK (Mediana\Sdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the Project document: 1.0.1' . PHP_EOL;
