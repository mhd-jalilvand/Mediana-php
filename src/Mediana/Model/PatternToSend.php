...
/**
 * PatternToSend Class Doc Comment
 *
 * @category Class
 * @package  Mediana\Sdk
 * @author   Mediana Team
 ...
 */
class PatternToSend implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatternToSend';
    ...
    {
        $this->setIfExists('pattern_code', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pattern_code'] === null) {
            $invalidProperties[] = "'pattern_code' can't be null";
        }
    ...
    {
        return $this->container['pattern_code'];
    }
    ...
    public function setPatternCode($pattern_code)
    {
        if (is_null($pattern_code)) {
            throw new \InvalidArgumentException('non-nullable pattern_code cannot be null');
        }
        $this->container['pattern_code'] = $pattern_code;
